  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-10 text-center">
        <div className="mx-auto w-16 h-16 rounded-2xl bg-pink-100 flex items-center justify-center mb-6">
        ...
        <span className="mt-2 inline-block text-xs font-bold uppercase tracking-widest text-pink-600 bg-pink-50 px-3 py-1 rounded-full">
          Manager
        </span>
